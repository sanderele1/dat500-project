...
python3 conversion.py --hadoop-streaming-jar /usr/local/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.1.jar -r hadoop SRR17981961.head --output-dir hdfs:///dis_materials/output1 --no-cat-output
