...
# testing: python3 hbase_insert.py --hadoop-streaming-jar /usr/local/hadoop/share/hadoop/tools/lib/hadoop-streaming-3.3.1.jar -r hadoop hdfs:///files/hadoop_test --output-dir hdfs:///dis_materials/sliding --no-cat-output
